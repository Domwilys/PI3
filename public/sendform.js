...
function submit_suggest_form(e) {//Função que envia o formulário de sugestão sem recarregar a página
    ...
    fetch('/', {//Reconhece a rota do formulário, o método "Post", e insere o JSON para trabalhar com os objetos
        ...
        body: JSON.stringify({//Transforma os objetos listados em um JSON
            ...
            sobre: document.getElementById("sobre_campo").value,
            experiencia: document.getElementById("experiencia_campo").value,
            formacaoAcademica: document.getElementById("formacaoAcademica_campo").value,
            skills: document.getElementById("skills_campo").value
        })
    })
    ...
    document.getElementById("sobre_campo").value = '';
    document.getElementById("experiencia_campo").value = '';
    document.getElementById("formacaoAcademica_campo").value = '';
    document.getElementById("skills_campo").value = '';
